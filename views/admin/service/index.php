                                ...
                                <div class="modal-body">
                                    <form id="myform" class="mt-0" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="dropify-wrapper"><div class="dropify-message"><span class="file-icon"></span> <p>یک فایل را در اینجا بکشید یا رها کنید یا کلیک کنید</p><p class="dropify-error">اوه، اشتباه اتفاق افتاد.</p></div><div class="dropify-loader"></div><div class="dropify-errors-container"><ul></ul></div><input name="image" type="file" class="dropify" required=""><button type="button" class="btn btn-sm btn-primary btn-round dropify-clear">حذف</button><div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-filename"><span class="dropify-filename-inner"></span></p><p class="dropify-infos-message">کشیدن و رها کردن یا برای جایگزینی کلیک کنید</p></div></div></div></div>
                                        </div>
                                ...
                                <table id="individual-col-search" class="table table-hover x">
                                    ...
                                    foreach ($service as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a style="float: right;display: block;width: 50px;">
                                                    <img style="width: 100%;" src="assets/images/service/<?= $row['id']; ?>/service.png">
                                                </a>
                                            </td>
                                            <td>
                                                <?= $row['title']; ?>
