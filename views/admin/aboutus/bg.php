                                ...
                                <div class="modal-body">
                                    <form action="adminaboutus/addbg" enctype="multipart/form-data" id="myform" class="mt-0" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="pretitle" class="form-control mb-2" id="exampleInputUsername1" placeholder="پیش عنوان">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="video" class="form-control mb-2" id="exampleInputUsername1" placeholder="ویدیو">
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal" data-target="#registerModal">
                                                    <i onclick="editBg(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editBg(bgId) {

        editBgId = bgId;

        var url = 'adminaboutus/editbg/' + bgId;
        var data = {};

        $.post(url, data, function (msg) {

            $('input[name=pretitle]').val(msg['pretitle']);
            $('textarea[name=title]').val(msg['title']);
            $('textarea[name=posttitle]').val(msg['posttitle']);
            $('textarea[name=description]').val(msg['description']);
            $('input[name=video]').val(msg['video']);
    ...
    function submitForm(){
        ...
        $.ajax({
            type: 'POST',
            url: 'adminaboutus/addbg/'+editBgId,
