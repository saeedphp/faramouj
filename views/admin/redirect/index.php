                                ...
                                <div class="modal-body">
                                    <form id="myform" class="mt-0" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="currentUrl" class="form-control mb-2" id="exampleInputEmail2" placeholder="آیکون">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="targetUrl" class="form-control mb-2" id="exampleInputEmail2" placeholder="آیکون">
                                        </div>
